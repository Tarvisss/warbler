...
def profile():
    ...
    if form.validate_on_submit():
        ...
        try:
            User.update_user(
                username = form.username.data or user.username,  # Keep existing username if not provided
                email = form.email.data,
                image_url = form.image_url.data or user.image_url, # Keep existing image if not provided
